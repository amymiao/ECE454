...
time ./randtrack 1 50 > rt1.out; sort -n rt1.out > rt1.outs;
rm rt1.out

#compute randtrack with 2 threads, 50 results
time ./randtrack 2 50 > rt2.out; sort -n rt2.out > rt2.outs;
rm rt2.out

#compute randtrack with 4 threads, 50 results
time ./randtrack 4 50 > rt4.out; sort -n rt4.out > rt4.outs;
rm rt4.out
